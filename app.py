...
class DegreeCertificate(FPDF):
    ...
    def add_digital_stamp(self, college_name):
        # Stamp Color: Deep Blue (Ink Style)
    ...
    def generate_degree(self, d):
        ...
        self.cell(0, 15, f"{d['degree']}", 0, 1, 'C')
        ...
        # Fixed the unterminated f-string here
...
if submitted:
    if s_name:
        ...
        st.error("Bhai student ka naam toh daalo!")
